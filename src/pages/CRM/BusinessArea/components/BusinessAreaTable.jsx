...
export default function BusinessAreaTable(
  { data, 
    rowSelection,
    editBusinessArea,  
    keyTable,    
   ...
   <div> 
    {(data?.length === 0 && !loading) ? (
      <div className="text-center" style={{ color: 'hsla(0, 0%, 0%, 0.45)' }}>
        ...
        />
        <h3>
          Não há dados aqui. Para cadastrar clique em <b>Nova área de negócio</b>
        </h3>
      </div>
     ) : (
      <DefaultTable
