...
const CommissioningFranchiseeReportTableDetail = (props) => {
  ...
  const columns = [
    {
      ...
      render: (text, record) => (
          <Tooltip title={<Row>
                            <Col>{`Organização: ${record.companyShortName}`}</Col>
                            <Col>{`Franqueado: ${record.franchiseeShortName}`}</Col>
                          </Row>
                          }   
          >                            
              {record.number}
...
CommissioningFranchiseeReportTableDetail.propTypes = {
  proposals: PropTypes.array,
  getProposal: PropTypes.func,
}
export default CommissioningFranchiseeReportTableDetail
