...
export default {
  ...
  define: {
    ...
    'process.env.UMI_API_LAYOUT_GENERATOR': 'http://localhost:4560', //'https://services.dev.gravittem.com.br/Gravittem/GeradorLayout',
    ...
    'process.env.UMI_API_HOST_NEW_CONTRACT': 'http://localhost:4500',
  },
  plugins: [
